structure(list(method = "GET", url = "https:///users", status_code = 403L, 
    headers = structure(list(date = "Sat, 14 Feb 2026 18:02:15 GMT", 
    ...
    starttransfer = 0.321908, total = 0.322852), cache = new.env(parent = emptyenv())), class = "httr2_response")
